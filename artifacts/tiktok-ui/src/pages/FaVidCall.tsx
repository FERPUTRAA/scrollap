...
import { Phone, MapPin, Heart, Share2, UserPlus, Mic, MicOff, Video, VideoOff } from "lucide-react";
...
// Placeholder cards — no logic, no API. Data real datang dari server terpisah.
const PLACEHOLDER_CARDS: VidCallCard[] = [
  {
    id: "1",
    callerName: "Rina Sari",
    callerHandle: "@rina_sari",
    callerAvatar: "https://i.pravatar.cc/150?img=47",
    receiverName: "Budi W.",
    receiverAvatar: "https://i.pravatar.cc/150?img=15",
    distance: "1.2 km",
    duration: "12:34",
    bg: "linear-gradient(160deg,#1a1a2e 0%,#16213e 50%,#0f3460 100%)",
    topic: "Ngobrol santai sore hari",
  },
  {
    id: "2",
    callerName: "Dewi Ayu",
    callerHandle: "@dewi_ayu",
    callerAvatar: "https://i.pravatar.cc/150?img=5",
    receiverName: "Agus R.",
    receiverAvatar: "https://i.pravatar.cc/150?img=52",
    distance: "0.8 km",
    duration: "04:12",
    bg: "linear-gradient(160deg,#0f2027 0%,#203a43 50%,#2c5364 100%)",
    topic: "Diskusi project bareng",
  },
  {
    id: "3",
    callerName: "Sinta P.",
    callerHandle: "@sinta_p",
    callerAvatar: "https://i.pravatar.cc/150?img=9",
    receiverName: "Reza M.",
    receiverAvatar: "https://i.pravatar.cc/150?img=60",
    distance: "2.5 km",
    duration: "28:01",
    bg: "linear-gradient(160deg,#2d1b69 0%,#1a0533 50%,#11998e 100%)",
    topic: "Nonton bareng online",
  },
  {
    id: "4",
    callerName: "Fani K.",
    callerHandle: "@fani_k",
    callerAvatar: "https://i.pravatar.cc/150?img=44",
    receiverName: "Hendra S.",
    receiverAvatar: "https://i.pravatar.cc/150?img=33",
    distance: "500 m",
    duration: "01:55",
    bg: "linear-gradient(160deg,#1f1c2c 0%,#3a1f5e 50%,#928dab 100%)",
    topic: "Rencana makan malam",
  },
  {
    id: "5",
    callerName: "Citra L.",
    callerHandle: "@citra_l",
    callerAvatar: "https://i.pravatar.cc/150?img=1",
    receiverName: "Doni A.",
    receiverAvatar: "https://i.pravatar.cc/150?img=25",
    distance: "3.1 km",
    duration: "07:48",
    bg: "linear-gradient(160deg,#141e30 0%,#0a2342 50%,#243b55 100%)",
    topic: "Latihan musik bersama",
  },
];
...
function VidCallCardItem({ card }: { card: VidCallCard }) {
  ...
  return (
    ...
    >
      {/* Ambient blobs untuk efek video call */}
      <div
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 z-10 px-8">
        ...
        {/* Secondary caller (receiver) - smaller */}
        <motion.div
...
export default function FaVidCall() {
  ...
  return (
    <div className="relative h-full w-full bg-black">
      ...
      >
        ...
        <div className="flex gap-5 items-center font-bold text-[15px] drop-shadow pointer-events-auto">
          ...
          >
            ...
            {activeTab === "Nearby" && (
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 hidden" />
            )}
          </button>
        </div>
      ...
      {/* Active tab underline for Nearby */}
      {activeTab === "Nearby" && (
        <div className="absolute z-30" style={{ top: "calc(48px + 1.5rem + 15px + 3rem)", left: "50%", transform: "translateX(calc(-50% - 2.5rem))" }}>
