...
async function tryJoinAgora(
  ...
  // 1. VAVA original token (generated by VAVA backend for this exact channel)
  // 2. serverToken (cert-signed by our backend — fallback)
  // 3. Fresh server token (generated now from /api/agora/token)
  ...
  // uid=0 is always tried; if a specific uid was provided, try it first
